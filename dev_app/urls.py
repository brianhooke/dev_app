...
from core.views.pos import view_po_by_unique_id, view_po_pdf_by_unique_id, submit_po_claim, approve_po_claim, upload_bill_pdf
from core.views.dashboard import dashboard_view

urlpatterns = [
    # Dashboard homepage (root level) - moved from dashboard app
    ...
    path('po/<str:unique_id>/upload-invoice/', upload_bill_pdf, name='upload_bill_pdf'),
