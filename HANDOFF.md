...
**Last updated:** 28 May 2026 (v257 — staged for deploy: HC variations + allocations may be negative; supersedes the v256 zip)
...
- **Local code-state version**: `v257` — staged for next deploy. v253 + v254 + v255 + v256 + v257 changes folded into one zip:
