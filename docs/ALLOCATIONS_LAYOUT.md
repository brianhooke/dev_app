# AllocationsLayout Documentation

A reusable JavaScript module for managing data tables with allocations, used across Quotes, Bills, and PO sections.

**File:** `core/static/core/js/allocations_layout.js`

---

## 1. Feature Flags

See [[AL_Feature_Flags]] for the complete feature flags reference.
...
| File | Purpose |
|------|---------|
| `core/static/core/js/allocations_layout.js` | The module itself |
| `core/templates/core/components/allocations_layout.html` | HTML template for tables layout |
