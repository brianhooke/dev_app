...
from .views.contract_budget import contract_budget_view, update_uncommitted, update_fixed_on_site, get_project_committed_amounts, get_item_quote_allocations, get_item_bill_allocations, get_item_hc_variation_allocations, get_bill_for_viewer, validate_fix_contract_budget, fix_contract_budget, export_projects_c2c
...
urlpatterns = [
    ...
    path('get_bill_for_viewer/<int:bill_pk>/', get_bill_for_viewer, name='get_bill_for_viewer'),
    ...
    path('get_inbox_supplier/<int:contact_pk>/', get_inbox_supplier, name='get_inbox_supplier'),
